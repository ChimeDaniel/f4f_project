...
# Import the CSV files that were exported
...
print("✔ All Cleaned CSV files imported successfully!")
...
def create_tables():
    ...
    create_tables_query = """
                ...
                CREATE TABLE flour4four.fact_orders (
                    ...
                    flour_type_id     INT REFERENCES flour4four.dim_flour(flour_type_id),
